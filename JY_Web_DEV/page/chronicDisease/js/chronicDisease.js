$(document).ready(function(){
	...
	// 高血压家族史
	interactiveData(".listbox1", value1);
	//高血压并发症			
	interactiveData(".listbox2", value2);
	// 糖尿病家族史
	interactiveData(".listbox3", value3);
	// 糖尿病并发症
	interactiveData(".listbox4", value4);
	// 血糖控制状况
	interactiveData(".listbox6", value6);
	//保存数据
...
//			dataType: "JSON",
			data: {
				...
				"tnbkzArray": Object.values(value4),
				"tnbbfzArray": Object.values(value6) 
			},
			traditional: true, 
			success: function(data){
				console.log(data);
