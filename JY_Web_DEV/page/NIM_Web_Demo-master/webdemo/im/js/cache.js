...
var Cache = (function() {
  ...
  Cache.prototype.getFriendslistOnShow = function() {
    var array = [];
//  array=[
//					{account: "654321", nick: "654321", gender: "unknown", createTime: 1558689303956, updateTime: 1558689303956},
//					{account: "123456", nick: "123456", gender: "unknown", createTime: 1558403105345, updateTime: 1558403105345}
//		];
    for (var i = 0; i < this.friendslist.length; i++) {
      if (!this.inBlacklist(this.friendslist[i].account)) {
        array.push(this.getUserById(this.friendslist[i].account));
        array=[
						{account: "zkceshi3", nick: "zkceshi3", gender: "unknown", createTime: 1558689303956, updateTime: 1558689303956},
						{account: "zkceshi5", nick: "zkceshi5", gender: "unknown", createTime: 1558403105345, updateTime: 1558403105345}
					];//新加
//				array=[
//						{account: "654321", nick: "654321", gender: "unknown", createTime: 1558689303956, updateTime: 1558689303956},
//						{account: "123456", nick: "123456", gender: "unknown", createTime: 1558403105345, updateTime: 1558403105345}
//					];
        console.log("aaaaaaaaaaaaaaaalllllllllllllllllll",array);
//      debugger;
      }
    }
    return array;
