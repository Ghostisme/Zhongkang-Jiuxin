 ...
 var overlaycomplete = function(e) {
     ...
     if (whitchOver == 1) {
         var circleLng = cache1.getPosition().lng;
         var circleLat = cache1.getPosition().lat;
         viewDraw(1,"",circleLng, circleLat);
         return;
     }else if (whitchOver == 3) {
...
/*         var span2 = document.createElement('span');
         span2.appendChild(document.createTextNode("中心点：" + circleLng + "," + circleLat));
         li.appendChild(span2);*/
         $("#longitude").val(circleLng);
         $("#latitude").val(circleLat);
         $("#longitudepull").val(circleLng);
         $("#latitudepull").val(circleLat);
     }else if (isoverlays == 3) {
