  ...
  <div style="height: 100%;border: 1px solid #91a7b4;margin: 2px;">
    ...
    <div class="sanxd">
        ...
        <div class="xzd1d1 gundong">
          <div>
            <div class="df xzd1d1_d">
              ...
              <div class="zidov" v-on:click="shtitleClick">处置申请单(双击可修改)</div>
            </div>
      ...
      <div class="xzd1d2 gundong">
        <div class="checklBox">
          <div class="topBox">
            <page-table :dataSourceQu="dataSource" :hisData="column" @handleAdd="handleAdd" :pageKey="pagekey"></page-table>
            <!--<page-table :dataSource="dataSource" :hisData="column"></page-table>-->
          </div>
          <div class="lineBox" @mousedown="lineDrag"></div>
          <div class="bottomBox">
          	<a-table bordered :dataSource="dataSource1" :columns="columns1" :pagination="false">
	        <!--<a-table bordered :dataSourceQu="dataSource1" :columns="columns1" :pagination="false">-->
...
const columns = [
  ...
  },
  {
    ...
    dataIndex: "checkBox1",
    width: "50px",
    scopedSlots: { customRender: "checkBox1" }
  },
  {
    title: "备注",
