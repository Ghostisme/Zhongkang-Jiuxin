...
//      this.newFile()
    ...
    methods: {
      onitPatient(){
        this.userInfo=JSON.parse(localStorage.getItem('patInfos'))
        console.log('监听本地存储',this.userInfo);
        this.hisJspUrl="http://192.31.10.85:8081/215his/PharmacyResident.jsp?HOSP_AREA="+this.userInfo.HOSP_AREA+"&DEPT_CODE="+this.userInfo.DEPT_CODE+"&USER_ID="+this.userInfo.USER_ID+"&ID_NO="+this.userInfo.ID_NO+"&VISIT_ID="+this.userInfo.VISIT_ID
      },
      //菜单开始
