...
function newWebSocket() {
    ...
    if ('WebSocket' in window) {
        ...
        console.log('useruseruser::::', user);
          var wsUrl = "wss://www.jhydls.cn/wsApi/websocket/" + user.userCode;
        //var wsUrl = "wss://192.31.10.197:8003/wsApi/websocket/" + user.userSocket;
...
//      var wsUrl = "ws://192.31.10.197:8005/websocket/" + user.userCode;
