//window.src = "/Drugstore_Web/drugstore_pc/";
   window.src = "/zhongkangcode/JX_Cloud/Drugstore_Web/drugstore_pc/";
window.src = "/";
//下拉框
(function() {
	var num = 0;
...
//		var stringUrl="http://www.hzyypf.com:9000/pages/shop/shop_des.html?rec=276";
//		alert(stringUrl.split('/'));
		localStorage.setItem("loginJumpHref",window.location.href.split(window.src)[1]);
		window.location.href = window.src + "pages/login/login.html";
	});
	//点击顶部购物车
