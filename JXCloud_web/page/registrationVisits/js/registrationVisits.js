...
//	pageGo(".sumbitbtn", "../patient/patient.html");//确定按钮->患者管理页
	...
	$("#iDcard").blur(function(){
		...
		if(!(idcard_patter.test(identityCard))){
...
//						$("#iDcard").after('<label id="identityCode-error" class="warn" for="identityCode"><i class="fas fa-exclamation-triangle fa1"></i>  该身份证号已存在</label>');
						$("#iDcard").val(dataList.idCode);
						$("#phone").after('<label id="userTel-error" class="warn" for="userTel"><i class="fas fa-exclamation-triangle fa1"></i>  该手机号已存在</label>');
