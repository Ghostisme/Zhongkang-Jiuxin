...
//			}
			...
			dataContent(".medicalHistory", 0, 1, dataList.pastHistory);
			dataContent(".medicalHistory", 1, 0, dataList.allergyHistory);
			dataContent(".medicalHistory", 1, 1, dataList.familyHistory);
