	...
	return function(e) {
		...
		(function(e) {
			...
			var A = t.addEventListener = function(e, t, n) {
				...
				E = t.on = A,
				_ = t.removeEventListener = function(e, t, n) {
			...
			var o = function() {
				...
				return function t(n) {
					...
					var h, y, v, b, M, T = o ? !!c.likeChrome : /\bChrome\b/.test(n) && !/internal|\n/i.test(a.toString()),
						...
						w = I ? "b" : "β",
						A = s.document || {},
						E = s.operamini || s.opera,
						_ = r.test(_ = o && E ? E["[[Class]]"] : m(E)) ? _ : E = null,
						R = n,
						j = [],
						F = null,
						N = n == g,
					...
					if(U && (h = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(U) || /(?:alpha|beta)(?: ?\d)?/i.exec(n + ";" + (N && c.appMinorVersion)) || /\bMinefield\b/i.test(n) && "a") && (F = /b/i.test(h) ? "beta" : "alpha", U = U.replace(RegExp(h + "\\+?$"), "") + ("beta" == F ? w : x) + (/\d+\+?/.exec(h) || "")), "Fennec" == L || "Firefox" == L && /\b(?:Android|Firefox OS)\b/.test(H)) L = "Firefox Mobile";
					else if("Maxthon" == L && U) U = U.replace(/\.[\d.]+/, ".x");
		...
		}, e.exports = m, n(457), n(456), n(455), n(449), n(447), n(446), n(445), n(444), n(443), n(442), n(441), n(440), n(439), n(438), n(437), n(436), n(435)
	}, function(e, t, n) {
		"use strict";
		var r, s = n(9),
			i = (r = s) && r.__esModule ? r : {
		...
		c.info = u.info = i.info, e.exports = c, n(424), n(423), n(422), n(421), n(420), n(419), n(418), n(417), n(416), n(415), n(414), n(413), n(412), n(411), n(410), n(409), n(408)
	}, function(e, t) {
		var n = {}.toString;
		e.exports = function(e) {
		...
		}, e.exports = m, n(260), n(259), n(256), n(255), n(254), n(253), n(252)
	}, function(e, t, n) {
		var r = n(44);
		e.exports = function(e) {
			return Object(r(e))
		...
		"use strict";
		var r = n(470);
		r.fn = r.prototype, e.exports = r, n(467), n(466), n(465), n(464), n(463), n(462), n(461), n(460), n(459), n(458)
	}, function(e, t, n) {
		"use strict";
		var r = n(66),
			s = n(136),
		...
		function o(e) {
			r.undef(e.secure) && (e.secure = !0), this.options = r.copy(e), this.init(), this.connect(), this.initConnecting = !0
		}
		...
		a.init = function() {
			...
			var t = e.type,
				n = e.obj;
			this.api.emit(t, n)
		}, e.exports = o, n(251), n(249), n(248), n(247), n(246)
	}, function(e, t, n) {
		var r = n(27),
			s = n(26),
			i = n(17),
		...
		var r = n(60),
			s = n(40).concat("length", "prototype");
		...
		e.exports = !c || n(20)(function() {
			...
			for(var n = o(e), c = arguments.length, u = 1, l = s.f, m = i.f; c > u;)
				for(var d, p = a(arguments[u++]), f = l ? r(p).concat(l(p)) : r(p), g = f.length, h = 0; g > h;) m.call(p, d = f[h++]) && (n[d] = p[d]);
			return n
		} : c
	}, function(e, t, n) {
		var r = n(16);
		...
		var r = n(8),
			...
			$ = function(e, t, n) {
				return e === B && $(L, t, n), v(e), t = T(t, !0), v(n), s(D, t) ? (n.enumerable ? (s(e, j) && e[j][t] && (e[j][t] = !1), n = k(n, {
					enumerable: S(0, !1)
				})) : (s(e, j) || w(e, j, S(1, {})), e[j][t] = !0), J(e, t, n)) : w(e, t, n)
			},
			K = function(e, t) {
				v(e);
		...
		}, e.exports = m, n(404), n(403), n(402), n(401)
	}, function(e, t, n) {
		"use strict";
		var r = n(0);
					...
					function(e, t, n) {
						...
						e.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function(e) {
							...
							var t = this.connected,
								n = this.connecting;
							this.connected = !1, this.connecting = !1, this.open = !1, (t || n) && (this.transport.close(), this.transport.clearTimeouts(), t && (this.publish("disconnect", e), "booted" != e && this.options.reconnect && !this.reconnecting && this.reconnect()), n && (self.connectTimeoutTimer && clearTimeout(self.connectTimeoutTimer), this.tryNextTransport()))
		...
		}).call(this, __webpack_require__(30), __webpack_require__(250)(module))
	}, function(e, t, n) {
		"use strict";
		var r = {
				1: "ROOM_CLOSE",
			...
			var l = {
				...
				onerror: function(n) {
					try {
						...
						console.log("error: ignore error if could not parse obj.result", r), e.uploaddone(new s(n.message, n.code), t.options)
					}
				}
			};
		...
		o.sendText = function(e) {
			...
			function o(r, i) {
				if(e.uploaddone = n, r) e.done(r, e.callback.options);
					...
					if((i = m.parseResponse(i, t.options.exifOrientation)).url = l.genDownloadUrl(e.nosToken, s.Object), a.exist(e.fileInputName)) i.name = e.fileInputName;
					else if(e.blob) {
						var o = e.blob.name;
			...
			if(l.isWeixinApp) a.verifyOptions(e, "filePath", "msg::_doPreviewFile"), t.fileQuickTransfer(e, o, function() {
				wx.uploadFile({
					...
					success: function(e) {
						if(200 === e.statusCode) try {
							...
							console.log("error:", "parse wx upload file res error", t), o({
				...
				var c = {
					...
					success: function(e) {
						if(200 === e.statusCode) try {
							...
							console.log("error:", "parse nodejs upload file res error", t), o({
				...
				if(e.filePath) c.filePath = e.filePath;
				else {
				...
				var p = {
					...
					success: function(e) {
						if(e.ok && 200 === e.status) try {
							...
							console.log("error:", "parse React Native upload file res error", t), o({
			...
			if(e.type || (e.type = "file"), a.verifyParamPresentJustOne(e, "dataURL blob fileInput file filePath wxFilePath fileObject", "msg::sendFile"), this.processCallback(e), e.filePath = e.filePath || e.wxFilePath, delete e.wxFilePath, e.dataURL) this._previewAndSendFile(e);
			...
			return i.hasOwnProperty("chatroomId") && !i.chatroomId ? a.onError("聊天室未连接") : (s && (i.status = "success", i.isLocal = !0), t.storeSendMsg && (r.promise = t.storeSendMsg(i)), e.cbaop = function(e) {
		...
		o.setDebug = function() {
			...
			if(t.debug = e, e.style && (t.style = e.style), t.debug && s.exist(console)) {
				var n = console;
				t.debug = function() {
					var e = t.formatArgs(arguments); - 1 !== a.indexOf(r.name) && s.isString(e[0]) && (e[0] = "%c" + e[0], e.splice(1, 0, t.style)), t._log("debug", e)
				}, t.log = function() {
					var e = t.formatArgs(arguments); - 1 !== a.indexOf(r.name) && s.isString(e[0]) && (e[0] = "%c" + e[0], e.splice(1, 0, t.style)), t._log("log", e)
				}, t.info = function() {
					var e = t.formatArgs(arguments); - 1 !== a.indexOf(r.name) && s.isString(e[0]) && (e[0] = "%c" + e[0], e.splice(1, 0, t.style)), t._log("info", e)
				}, t.warn = function() {
					var e = t.formatArgs(arguments); - 1 !== a.indexOf(r.name) && s.isString(e[0]) && (e[0] = "%c" + e[0], e.splice(1, 0, t.style)), t._log("warn", e)
				}, t.error = function() {
					var e = t.formatArgs(arguments); - 1 !== a.indexOf(r.name) && s.isString(e[0]) && (e[0] = "%c" + e[0], e.splice(1, 0, t.style)), t._log("error", e)
				}, t._log = function(e, r) {
		...
		var r = n(0),
			...
			i = s.prototype,
			o = i.Message = n(71),
			a = i.TextMessage = n(399),
			c = i.FileMessage = n(128),
			u = i.GeoMessage = n(395),
			l = i.NotificationMessage = n(394),
			m = i.CustomMessage = n(393),
			d = i.TipMessage = n(392),
			p = i.RobotMessage = n(391);
		...
		"use strict";
		n(116).fn.refreshSocketUrl = function() {
			this.socketUrlsBackup = this.socketUrlsBackup || [], this.socketUrls = this.socketUrlsBackup.slice(0), this.logger.info("link::refreshSocketUrl"), this.connectToUrl(this.getNextSocketUrl())
		}
	}, function(e, t, n) {
		"use strict";
		n(141);
		...
		var r = n(0),
			...
			i = s.prototype,
			o = i.Message = n(72),
			a = i.TextMessage = n(433),
			c = i.FileMessage = n(130),
			u = i.GeoMessage = n(429),
			l = i.NotificationMessage = n(428),
			m = i.CustomMessage = n(427),
			d = i.TipMessage = n(426),
			p = i.RobotMessage = n(425);
		...
		s(s.S + s.F * !n(132)(function(e) {
			...
			from: function(e) {
				...
				if(h && (g = r(g, f > 2 ? arguments[2] : void 0, 2)), null == v || p == Array && a(v))
					...
					for(m = v.call(d), n = new p; !(s = m.next()).done; y++) u(n, y, h ? o(m, g, [s.value, y], !0) : s.value);
				return n.length = y, n
			}
		})
	}, function(e, t, n) {
		n(49), n(451), e.exports = n(7).Array.from
	}, function(e, t, n) {
		e.exports = {
			default: n(452),
			__esModule: !0
		...
		o.beforeSync = function() {
			...
			var t, n, r, s, o, f, g, h, y, v, b, M, T, S, k, C, P, I, O, x, w, A, E = this,
				_ = E.db,
				R = _.enable,
				j = E.options,
				F = E.syncPromiseArray,
				N = E.syncResult;
			if(F && F.length) {
						...
						var r = this,
							...
							c = function(e, t) {
								var n = "next",
									...
									p = function e() {
										var t;
										return t = arguments[0], 1 == (c = "array" === g(t) ? arguments[0] : Array.prototype.slice.call(arguments, 0, 2)).length && c.unshift(0),
											function(e) {
												return "number" === g(e)
											}(c[1]) || (c = null), {
												execute: m,
